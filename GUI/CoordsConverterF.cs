...
namespace EnhancedMap.GUI
{
    public partial class CoordsConverterF : CustomForm
    {
        ...
        public CoordsConverterF()
        {
            ...
            customFlatButtonSwitch.Click += (sender, e) => 
            {
                Switch();
            };
        }
        ...
        private void CreateUI_XY()
        {
            ...
            NumericTextBox textBoxX = new NumericTextBox()
            {
                Location = new Point(5 + labelX.Width, 5),
                Text = "0"
            };
            ...
            {
                Text = "Y:",
                Location = new Point(5, labelX.Height + 5),
                ForeColor = Color.White
            };

            NumericTextBox textBoxY = new NumericTextBox()
            {
                Location = new Point(labelY.Width + 5, labelY.Height + 5),
                Text = "0"
            };
            ...
            {
                Text = "Map:",
                Location = new Point(5, labelY.Height + labelX.Height + 5),
                ForeColor = Color.White
            };

            ComboBox comboBoxMap = new ComboBox()
            {
                Location = new Point(labelMap.Width + 5, labelY.Height + labelX.Height + 5),
            ...
            {
                comboBoxMap.Items.Add(map.Index);
            }
            ...
            _handlerGO = delegate (object sender, EventArgs e)
            {
                if (!Global.FreeView)
            ...
            _handerReset = delegate (object sender, EventArgs e)
            {
                if (Global.FreeView)
        ...
        private void CreateUI_LATLONG()
        {
            ...
            NumericTextBox textBoxDegreesLat = new NumericTextBox()
            {
                Text = "0",
                TextAlign = HorizontalAlignment.Center,
                Width = 50,
                Location = new Point(5 + labelLat.Width, 5)
            };
            ...
            Label labelFirst = new Label()
            {
                Text = "°",
                ForeColor = Color.White,
                Location = new Point(5 + labelLat.Width + textBoxDegreesLat.Width, 5),
                Width = 25,
            };

            NumericTextBox textBoxMinLat = new NumericTextBox()
            {
                Text = "0",
                TextAlign = HorizontalAlignment.Center,
                Width = 50,
                Location = new Point(5 + labelLat.Width + textBoxDegreesLat.Width + labelFirst.Width, 5)
            };
            ...
            Label labelSec = new Label()
            {
                Text = "'",
                ForeColor = Color.White,
                Location = new Point(5 + labelLat.Width + textBoxDegreesLat.Width + labelFirst.Width + textBoxMinLat.Width, 5),
                Width = 25,
            };

            ComboBox comboBoxLat = new ComboBox()
            {
                DropDownStyle = ComboBoxStyle.DropDownList,
                Location = new Point(5 + labelSec.Width + labelLat.Width + textBoxDegreesLat.Width + labelFirst.Width + textBoxMinLat.Width, 5),
                Width = 50
            };
            ...
            NumericTextBox textBoxDegreesLong = new NumericTextBox()
            {
                Text = "0",
                TextAlign = HorizontalAlignment.Center,
                Width = 50,
                Location = new Point(5 + labelLat.Width, 35)
            };

            Label labelFirst1= new Label()
            {
                Text = "°",
                ForeColor = Color.White,
                Location = new Point(5 + labelLat.Width + textBoxDegreesLat.Width, 35),
                Width = 25,
            };

            NumericTextBox textBoxMinLong = new NumericTextBox()
            {
                Text = "0",
                TextAlign = HorizontalAlignment.Center,
                Width = 50,
                Location = new Point(5 + labelLat.Width + textBoxDegreesLat.Width + labelFirst.Width, 35)
            };

            Label labelSec1 = new Label()
            {
                Text = "'",
                ForeColor = Color.White,
                Location = new Point(5 + labelLat.Width + textBoxDegreesLat.Width + labelFirst.Width + textBoxMinLat.Width, 35),
                Width = 25,
            };

            ComboBox comboBoxLong = new ComboBox()
            {
                DropDownStyle = ComboBoxStyle.DropDownList,
                Location = new Point(5 + labelSec.Width + labelLat.Width + textBoxDegreesLat.Width + labelFirst.Width + textBoxMinLat.Width, 35),
                Width = 50
            };
