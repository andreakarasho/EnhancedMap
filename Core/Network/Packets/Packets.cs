...
namespace EnhancedMap.Core.Network
{
    ...
    {
        public PPlayerData(ushort x, ushort y, byte map, ushort hp, ushort stam, ushort mana, ushort maxhp, ushort maxstam, ushort maxmana, byte flag, bool death, bool panic, int color, string fontName, float fontSize, byte fontStyle) : base(0x25)
        {
            int offset = NetworkManager.SocketClient.Protocol == Protocol.Protocol03 ? 0 : 1;
